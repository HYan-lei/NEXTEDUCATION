...
import { Cpu, CheckCircle, Bot } from 'lucide-react';
import { useLanguage } from '../context/LanguageContext';
import { translations } from '../data/translations';

export default function OrcaProgram() {
  const { language } = useLanguage();
  const t = translations[language].orca_program;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-1">
            <div className="bg-slate-50 p-8 border border-slate-200 sticky top-24">
              ...
              <div className="mb-8">
                <h4 className="font-bold text-xs uppercase tracking-wider text-slate-500 mb-2">{t.season_title}</h4>
                <p className="text-sm text-slate-600">{t.season_desc}</p>
              </div>
